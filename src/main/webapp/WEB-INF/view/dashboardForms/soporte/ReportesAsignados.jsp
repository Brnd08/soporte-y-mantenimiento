...
<%
    ...
    System.out.println("reportes asignados " + reportesAsignados);

    String errorResolucionReporteSoporte = (String) session.getAttribute("errorResolucionReporteSoporte");
    System.out.println(errorResolucionReporteSoporte);

    String exitoResolucionReporteSoporte = (String) session.getAttribute("exitoResolucionReporteSoporte");
...
<div class="col-md-10 mx-auto col-lg-10">
    <form method="post" action="/solucion-reporte"
        ...
        <div class="form-floating mb-3">
            <textarea id="solucion-soporte" name="solucion" class="form-control"
                      rows="5" placeholder="No se muestran correctamente todos los campos en el formulario"
                      required maxlength="100"></textarea>
            <label for="solucion-soporte">Solucion al problema</label>
            <div class="invalid-feedback">
